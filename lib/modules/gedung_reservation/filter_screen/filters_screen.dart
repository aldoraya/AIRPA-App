...
import 'package:penyewaan_gedung_app/models/popular_filter_list.dart';
import 'package:penyewaan_gedung_app/modules/gedung_reservation/filter_screen/slider_view.dart';
    ...
    return Column(
      ...
      children: <Widget>[
        Padding(
          ...
          child: Text(
            Locs.alized.type_of_accommodation,
      ...
      children: <Widget>[
        Padding(
          padding:
              const EdgeInsets.only(left: 16, right: 16, top: 16, bottom: 8),
          child: Text(
           Locs.alized.distance_from_city,
            textAlign: TextAlign.left,
            style: TextStyle(
                color: Colors.grey,
                fontSize: MediaQuery.of(context).size.width > 360 ? 18 : 16,
