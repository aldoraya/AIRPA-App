...
class ChangepasswordScreenState extends State<ChangePasswordScreen> {
        ...
        child: Column(
          ...
          children: <Widget>[
            CommonAppbarView(
              ...
              titleText: Locs.alized.change_password,
              onBackClick: () {
                ...
                child: Column(
                  children: <Widget>[
                    Padding(
                      ...
                      child: Row(
                        children: <Widget>[
                          Expanded(
                            child: Text(
                              Locs.alized.enter_your_new_password,
                    ...
                    CommonTextFieldView(
                      ...
                      titleText: Locs.alized.new_password,
                      padding: const EdgeInsets.only(left: 24, right: 24, bottom: 16),
                      hintText:
                          Locs.alized.enter_new_password,
                    ...
                    CommonTextFieldView(
                      ...
                      titleText:
                          Locs.alized.confirm_password,
                      padding: const EdgeInsets.only(left: 24, right: 24, bottom: 24),
                      hintText: Locs.alized.enter_confirm_password,
                      keyboardType: TextInputType.visiblePassword,
                      isObsecureText: true,
                      onChanged: (String txt) {},
                    ...
                    CommonButton(
                      padding: const EdgeInsets.only(left: 24, right: 24, bottom: 16),
                      buttonText: Locs.alized.apply_text,
                      onTap: () {
                        if (_allValidation()) {
                          Navigator.pop(context);
                        }
  ...
  bool _allValidation() {
    ...
    if (_newController.text.trim().isEmpty) {
      _errorNewPassword = Locs.alized.password_cannot_empty;
      isValid = false;
    } else if (_newController.text.trim().length < 6) {
      _errorNewPassword = Locs.alized.valid_new_password;
      isValid = false;
    } else {
      _errorNewPassword = '';
    }
    if (_confirmController.text.trim().isEmpty) {
      _errorConfirmPassword =
          Locs.alized.password_cannot_empty;
      isValid = false;
    } else if (_newController.text.trim() != _confirmController.text.trim()) {
      _errorConfirmPassword =
         Locs.alized.password_not_match;
      isValid = false;
    } else {
      _errorConfirmPassword = '';
    }
