...
import 'package:penyewaan_gedung_app/constants/shared_preferences_keys.dart';
import 'package:get/get.dart';

class Locs extends GetxController {
  late Locale _locale;
  late AppLocalizations _appLocalizations;

  Future<Locs> init() async {
  ...
  static AppLocalizations get alized => Get.find<Locs>().appLocalizations;
}